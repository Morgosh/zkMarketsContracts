 ...
 */
export const LOCAL_STORAGE_KEY_PREFIX = `huego_session_${import.meta.env.VITE_NETWORK === "testnet" ? 'testnet' : 'mainnet'}_`;
 ...
 */
export const ENCRYPTION_KEY_PREFIX = `huego_encryption_key_${import.meta.env.VITE_NETWORK === "testnet" ? 'testnet' : 'mainnet'}_`;
